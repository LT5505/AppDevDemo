package com.liuting.imageswitcher.widget;
...
import com.liuting.imageswitcher.R;
...
public class SliderLayout extends RelativeLayout implements View.OnTouchListener, ViewSwitcher.ViewFactory {
    ...
    private Integer defaultImage = R.mipmap.ic_default;//默认图片
    private Integer errorImage = R.mipmap.ic_default;//默认图片
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (array != null) {
            ...
            for (IndicatorShape shape : IndicatorShape.values()) {
                if (indicatorShape.ordinal() == intShape) {
                    indicatorShape = shape;
                    break;
                }
            }
            //获取底部指示器的形状
            int intPosition = array.getInt(R.styleable.SliderLayout_sl_indicator_position, indicatorPosition.ordinal());
            for (IndicatorPosition position : IndicatorPosition.values()) {
                if (indicatorPosition.ordinal() == intPosition) {
            ...
            defaultImage = array.getInteger(R.styleable.SliderLayout_sl_default_image, defaultImage);
            errorImage = array.getInteger(R.styleable.SliderLayout_sl_error_image, errorImage);
        }
